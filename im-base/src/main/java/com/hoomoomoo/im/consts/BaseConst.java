...
public class BaseConst {
     ...
     * 当前系统存在数据表
     */
    public static String SYSTEM_TABLE;

    static {
        StringBuffer configTable = new StringBuffer();
        configTable.append("'sys_user'").append(",");
        configTable.append("'sys_role'").append(",");
        configTable.append("'sys_user_role'").append(",");
        configTable.append("'sys_menu'").append(",");
        configTable.append("'sys_role_menu'").append(",");
        configTable.append("'sys_dictionary'").append(",");
        configTable.append("'sys_parameter'").append(",");
        configTable.append("'sys_notice'").append(",");
        configTable.append("'sys_version'").append(",");
        configTable.append("'sys_login_log'").append(",");
        configTable.append("'sys_income'").append(",");
        configTable.append("'sys_gift'").append(",");
        configTable.append("'sys_interface'").append(",");
        configTable.append("'sys_wechat_user'").append(",");
        configTable.append("'sys_wechat_flow'").append(",");
        configTable.append("'sys_config'");
        SYSTEM_TABLE = configTable.toString();
    }

    /**
     * SWAGGER 请求
     */
    public static final String SWAGGER_REQUEST = "swagger";

    /**
     * SWAGGER 请求
     */
    public static final String SWAGGER_API_DOCS_REQUEST = "api-docs";
