...
public class LoginFilterConfig implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (StringUtils.isNotBlank(RunDataConfig.SYSTEM_USED_STATUS)) {
            if (isAjaxRequest(request)) {
                response.setHeader(STATUS, RunDataConfig.SYSTEM_USED_STATUS);
                String message = STR_EMPTY;
                if (RunDataConfig.SYSTEM_USED_STATUS.equals(SYSTEM_STATUS_INIT)) {
                    message = LOG_BUSINESS_TYPE_INIT_SYSTEM;
                } else if (RunDataConfig.SYSTEM_USED_STATUS.equals(SYSTEM_STATUS_UPDATE)) {
                    message = LOG_BUSINESS_TYPE_UPDATE_SYSTEM;
                } else if (RunDataConfig.SYSTEM_USED_STATUS.equals(SYSTEM_STATUS_BACKUP)) {
