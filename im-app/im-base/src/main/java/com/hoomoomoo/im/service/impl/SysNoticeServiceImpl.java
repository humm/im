...
import com.hoomoomoo.im.dao.SysNoticeDao;
...
public class SysNoticeServiceImpl implements SysNoticeService {
    ...
    public void save(SysNoticeModel sysNoticeModel) {
        ...
        if (StringUtils.isBlank(sysNoticeModel.getNoticeStatus())) {
            sysNoticeModel.setNoticeStatus(new StringBuffer(DictionaryConst.D007).append(MINUS).append(STR_1).toString());
        }
    ...
    public void update(SysNoticeModel sysNoticeModel) {
        ...
        SysCommonUtils.setCreateUserInfo(sysNoticeModel);
        if (StringUtils.isBlank(sysNoticeModel.getNoticeStatus())) {
            sysNoticeModel.setNoticeStatus(new StringBuffer(DictionaryConst.D007).append(MINUS).append(STR_2).toString());
        }
        SysLogUtils.parameter(logger, sysNoticeModel);
    ...
    public ResultData selectOne(String noticeId, Boolean isTranslate) {
        ...
        sysNotice.setReadStatus(new StringBuffer(DictionaryConst.D012).append(MINUS).append(STR_2).toString());
    ...
    public ResultData updateReadStatus(String isAll, String noticeIds) {
        ...
        sysNoticeModel.setReadStatus(new StringBuffer(DictionaryConst.D012).append(MINUS).append(STR_2).toString());
        SysCommonUtils.setModifyUserInfo(sysNoticeModel);
