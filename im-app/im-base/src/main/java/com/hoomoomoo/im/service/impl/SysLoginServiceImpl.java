...
public class SysLoginServiceImpl implements SysLoginService {
    ...
    @Autowired
    private com.hoomoomoo.im.dao.SysUserDao SysUserDao;
    ...
    public ResultData login(HttpServletRequest request, HttpServletResponse response, SysUserModel sysUserModel) {
        ...
        if (CollectionUtils.isEmpty(sysUserModelList)) {
            ...
            sysLoginLogModel.setLoginStatus(new StringBuffer(DictionaryConst.D002).append(MINUS).append(STR_2).toString());
            ...
            if (flag && inputPassword.equals(savePassword)) {
                ...
                sysLoginLogModel.setLoginStatus(new StringBuffer(DictionaryConst.D002).append(MINUS).append(STR_1).toString());
