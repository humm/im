...
public class InitConfigTest {
    ...
    public void build_01() throws Exception {
        InitConfigUtils.buildLicense(APP_CODE_SHOPPING);
    }
    ...
    public void build_02() throws Exception {
        InitConfigUtils.buildConfig(APP_CODE_SHOPPING);
    }
    ...
    public void build_03() throws Exception {
        InitConfigUtils.updateConfig(APP_CODE_SHOPPING);
    }
    ...
    public void build_04() {
        InitConfigUtils.updateVersion(APP_CODE_SHOPPING);
    }
