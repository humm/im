...
public class MenuFunctionConfig {
    ...
    public enum FunctionConfig {
        // TA工具组件 0-999
        SVN_LOG("100", "提交记录", "/conf/fxml/svnLog.fxml", "svnLog", "svnLog", "menuRepository", "用户信息,提交记录"),

        SVN_UPDATE("110", "文件更新", "/conf/fxml/svnUpdate.fxml", "svnUpdate", "svnUpdate", "menuRepository", "用户信息,文件更新"),

        SVN_REALTIME_STAT("120", "实时统计", "/conf/fxml/svnRealtimeStat.fxml", "svnRealtimeStat", "svnRealtimeStat", "menuRepository", "用户信息,统计用户,实时统计"),

        SVN_HISTORY_STAT("130", "历史统计", "/conf/fxml/svnHistoryStat.fxml", "svnHistoryStat", "svnHistoryStat", "menuRepository", "用户信息,统计用户,历史统计"),
        ...
        COPY_CODE("300", "复制文件", "/conf/fxml/copyCode.fxml", "copyCode", "copyCode", "menuFile", "复制文件"),

        FILE_SYNC("420", "同步文件", "/conf/fxml/fileSync.fxml", "fileSync", "fileSync", "menuFile", "同步文件"),

        SCRIPT_CHECK("500", "检查文件", "/conf/fxml/scriptCheck.fxml", "scriptCheck", "scriptCheck", "menuFile", "检查文件"),


        //GENERATE_CODE("310", "生成代码", "/conf/fxml/generateCode.fxml", "generateCode", "generateCode", "menuFile", "生成代码"),

        TASK_TODO("400", "开发任务", "/conf/fxml/hepTaskTodo.fxml", "hepTaskTodo", "hepTaskTodo", "menuHep", "开发任务"),

        TASK_SYNC("410", "同步需求", "/conf/fxml/hepTaskSync.fxml", "hepTaskSync", "hepTaskSync", "menuHep", "同步需求"),

        CHANGE_FUNCTION_TOOL("600", "版本切换", "/conf/fxml/changeFunctionTool.fxml", "changeFunctionTool", "changeFunctionTool", "menuHep", "版本切换"),


        SYSTEM_TOOL("700", "系统工具", "/conf/fxml/systemTool.fxml", "systemTool", "systemTool", "menuSet", "系统工具"),
