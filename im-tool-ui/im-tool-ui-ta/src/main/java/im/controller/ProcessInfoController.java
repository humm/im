...
import im.cache.TaskMemoryCache;
import im.cache.TransMemoryCache;
...
import static im.consts.FunctionConfig.PROCESS_INFO;
...
public class ProcessInfoController extends BaseController implements Initializable {
    ...
    void executeSubmit(ActionEvent event) {
        try {
            ...
            if (!CommonUtils.checkConfig(log, PROCESS_INFO.getCode())) {
                return;
            }
            setProgress(0);
