...
public class GenerateSql {
    ...
    public static String init(GenerateCodeDto generateCodeDto) throws Exception {
        ...
        content.append("insert into tsys_menu (menu_code, kind_code, trans_code, sub_trans_code, menu_name, menu_arg, menu_icon, window_type, tip, hot_key, parent_code, order_no, open_flag, tree_idx, remark, window_model)").append(SYMBOL_NEXT_LINE);
        content.append("values ('" + secondMenu + "', 'console-fund-ta-vue', 'menu', 'menu', '" + secondMenuName + "', ' ', 'u-a-systemmenu', ' ', ' ', ' ', '" + firstMenu + "', " + generateCodeDto.getMenuOrder() + ", ' ', '/console-fund-ta-vue/" + firstMenu + "/" + secondMenu + "/', ' ', ' ');").append(SYMBOL_NEXT_LINE_2);

        content.append("-- 自建业务 -- 三级目录 - " + firstMenuName + " - " + secondMenuName + " - " + functionName).append(SYMBOL_NEXT_LINE);
        content.append("delete from tsys_menu where menu_code = '" + functionCode + "';").append(SYMBOL_NEXT_LINE);
        content.append("insert into tsys_menu (menu_code, kind_code, trans_code, sub_trans_code, menu_name, menu_arg, menu_icon, window_type, tip, hot_key, parent_code, order_no, open_flag, tree_idx, remark, window_model)").append(SYMBOL_NEXT_LINE);
        content.append("values ('" + functionCode + "', 'console-fund-ta-vue', '" + functionCode + "', '" + functionCode + "Query', '" + functionName + "', ' ', 'u-a-systemmenu', ' ', ' ', ' ', '" + secondMenu + "', " + generateCodeDto.getMenuOrder() + ", ' ', '/console-fund-ta-vue/" + firstMenu + "/" + secondMenu + "/" + functionCode + "', ' ', ' ');").append(SYMBOL_NEXT_LINE_2);

        content.append("-- 自建业务 -- 三级目录 - " + firstMenuName + " - " + secondMenuName + " - " + functionName).append(SYMBOL_NEXT_LINE);
        content.append("delete from tsys_trans where trans_code = '" + functionCode + "';").append(SYMBOL_NEXT_LINE);
        ...
        content.append("delete from tsys_subtrans where trans_code = '" + functionCode + "' and sub_trans_code = '" + functionCode + "Query';").append(SYMBOL_NEXT_LINE);
        ...
        content.append("values ('" + functionCode + "', '" + functionCode + "Query', '" + functionName + "查询', ' ', ' ', '1', '1', ' ', '1', ' ', ' ');").append(SYMBOL_NEXT_LINE);

        if (PAGE_TYPE_SET.equals(generateCodeDto.getPageType())) {
            content.append("delete from tsys_subtrans where trans_code = '" + functionCode + "' and sub_trans_code = '" + functionCode + "Add';").append(SYMBOL_NEXT_LINE);
            content.append("insert into tsys_subtrans (trans_code, sub_trans_code, sub_trans_name, rel_serv, rel_url, ctrl_flag, login_flag, remark, ext_field_1, ext_field_2, ext_field_3)").append(SYMBOL_NEXT_LINE);
            content.append("values ('" + functionCode + "', '" + functionCode + "Add', '" + functionName + "新增', ' ', ' ', '1', '1', ' ', '1', ' ', ' ');").append(SYMBOL_NEXT_LINE);

            content.append("delete from tsys_subtrans where trans_code = '" + functionCode + "' and sub_trans_code = '" + functionCode + "Edit';").append(SYMBOL_NEXT_LINE);
            content.append("insert into tsys_subtrans (trans_code, sub_trans_code, sub_trans_name, rel_serv, rel_url, ctrl_flag, login_flag, remark, ext_field_1, ext_field_2, ext_field_3)").append(SYMBOL_NEXT_LINE);
            content.append("values ('" + functionCode + "', '" + functionCode + "Edit', '" + functionName + "修改', ' ', ' ', '1', '1', ' ', '1', ' ', ' ');").append(SYMBOL_NEXT_LINE);

            content.append("delete from tsys_subtrans where trans_code = '" + functionCode + "' and sub_trans_code = '" + functionCode + "Delete';").append(SYMBOL_NEXT_LINE);
            content.append("insert into tsys_subtrans (trans_code, sub_trans_code, sub_trans_name, rel_serv, rel_url, ctrl_flag, login_flag, remark, ext_field_1, ext_field_2, ext_field_3)").append(SYMBOL_NEXT_LINE);
            content.append("values ('" + functionCode + "', '" + functionCode + "Delete', '" + functionName + "删除', ' ', ' ', '1', '1', ' ', '1', ' ', ' ');").append(SYMBOL_NEXT_LINE);

            content.append("delete from tsys_subtrans where trans_code = '" + functionCode + "' and sub_trans_code = '" + functionCode + "Import';").append(SYMBOL_NEXT_LINE);
            content.append("insert into tsys_subtrans (trans_code, sub_trans_code, sub_trans_name, rel_serv, rel_url, ctrl_flag, login_flag, remark, ext_field_1, ext_field_2, ext_field_3)").append(SYMBOL_NEXT_LINE);
            content.append("values ('" + functionCode + "', '" + functionCode + "Import', '" + functionName + "导入', ' ', ' ', '1', '1', ' ', '1', ' ', ' ');").append(SYMBOL_NEXT_LINE);
        }
        content.append("delete from tsys_subtrans where trans_code = '" + functionCode + "' and sub_trans_code = '" + functionCode + "Export';").append(SYMBOL_NEXT_LINE);
        content.append("insert into tsys_subtrans (trans_code, sub_trans_code, sub_trans_name, rel_serv, rel_url, ctrl_flag, login_flag, remark, ext_field_1, ext_field_2, ext_field_3)").append(SYMBOL_NEXT_LINE);
        content.append("values ('" + functionCode + "', '" + functionCode + "Export', '" + functionName + "导出', ' ', ' ', '1', '1', ' ', '1', ' ', ' ');").append(SYMBOL_NEXT_LINE);
