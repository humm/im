...
import com.hoomoomoo.im.ui.ImFileUtils;
...
public class ImFileUiUtils {
     ...
     * 版本配置信息
     */
    private static List<Version> VERSION_CONFIG = new ArrayList<>();
     ...
     * 选择版本
     */
    private static Version SELECTED_VERSION = null;
...
//            JOptionPane.showMessageDialog(MAIN_FRAME, APP_LABEL.getDialogExecuteContent(), APP_LABEL.getDialogTitle(), JOptionPane.WARNING_MESSAGE);
    ...
    private static void syncSvn() {
        ...
        if (VERSION_CONFIG != null) {
            for (Version version : VERSION_CONFIG) {
    ...
    private static void initVersion() {
        ...
        version.removeAll();
        List<Version> versions = getModeVersion();
     ...
     * @return:
     */
    private static List<Version> getModeVersion() {
        List<Version> version = new ArrayList();
        for (Version item : VERSION_CONFIG) {
     ...
     * @return:
     */
    private static Version getSelectedVersion(String versionName) {
        Version version = new Version();
        List<Version> versionList = getModeVersion();
        if (versionList != null) {
            for (Version item : versionList) {
    ...
    private static void initWorkspace(String versionName) {
        Version version = getSelectedVersion(versionName);
        if (version != null) {
    ...
    private static void getVersionConfig(Map config) {
        if (config != null) {
            ...
            while (iterator.hasNext()) {
                ...
                Version itemVersion = new Version();
                // 获取版本号
