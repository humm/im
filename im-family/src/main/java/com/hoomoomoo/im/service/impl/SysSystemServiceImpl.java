...
import com.hoomoomoo.im.FamilyStarter;
...
public class SysSystemServiceImpl implements SysSystemService {
    ...
    public void outputConfigParameter() {
        ...
        try {
            InputStream inputStream = FamilyStarter.class.getClassLoader().getResourceAsStream(APPLICATION_PROPERTIES.split(COLON)[1]);
