...
<script>
    layui.config({
        ...
        var dictionaryCode = family.getUrlParameter("dictionaryCode");
        var dictionaryCaption = decodeURI(family.getUrlParameter("dictionaryCaption"));
        var userList = [];
        ...
        function addItem(userList, userId, dictionaryItem, dictionaryCaption) {
            ...
            item += '   <div class="layui-input-inline">';
            item += '       <input type="text" class="layui-input" name="userId" value="' + family.value(userId) + '">';
            item += '   </div>';
            item += '</div>';
            return item;
        }
