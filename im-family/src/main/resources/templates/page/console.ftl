...
<script>
    layui.config({
    ...
    }).use(['index', 'form', 'admin', 'carousel', 'im'], function () {
        var $ = layui.$,
            form = layui.form,
            admin = layui.admin,
        ...
        var url = {
            init: appName + "/selectConsoleData",
        ...
        var setValue = function (value) {
            if (im.isBlank(value) || value == '0' || value == '0.0' || value == '0.00') {
        ...
        // websocket订阅首页主题
        im.webSocket(url.websocketUrl, "console", function (data) {
            initData();
        });
